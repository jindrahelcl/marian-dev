...
Logits CTCDecoder::apply(Ptr<ExpressionGraph> graph,
...
// Copied from transformer decoder, see the @TODO there :)
void CTCDecoder::lazyCreateOutputLayer() {
  if(output_) // lazy
    return;
